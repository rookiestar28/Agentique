...
Before advertising `@agentique.io/uploader`, record registry readback, tarball inspection or package dry-run evidence, clean install smoke, and uploader CLI smoke evidence for the exact version being advertised.
